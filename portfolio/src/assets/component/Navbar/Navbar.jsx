  ...
  return (
    <div>
      <section className="flex flex-col justify-between h-screen ">
        <header className="flex justify-between items-center w-full px-4 mt-4 max-w-screen-xl mx-auto">
          <svg
            width="70"
            height="70"
            viewBox="0 0 406 368"
        ...
        <div className="flex -mt-36 relative">
          <div className="w-full px-4 max-w-screen-xl mx-auto">
            <svg
              ...
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="absolute top-0 left-1/2 -translate-y-[180px] -translate-x-1/2 w-[300px] sm:w-[400px] md:w-[650px] h-auto"
            >
              <path
            ...
            <div className="relative ml-4 md:ml-12">
              <h1 className="text-4xl md:text-6xl font-['Spartan'] mr-[12x]">
                Malika Lugun
              </h1>
              <p className="text-[24px] font-[Merriweather] italic md:mb-8 my-4">
                Mern
              </p>
              <button className="bg-[#4595eb] py-3 px-2 rounded font-extrbold bg-gradient-to-l from-[#1595b6] to-[#1f2667e6] relative hover:scale-110 ease-in-out duration-100 group">
                About Me
                <svg
                  width="44px"
                  height="44px"
                  ...
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="top-1/2 absolute -translate-y-1/2 -right-7"
                >
                  <path
          ...
          <ul className="ml-auto mr-8 space-y-6 text-[#b0b2c3] absolute right-8">
